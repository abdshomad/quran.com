(function( Quran, jQuery ) {
	Quran.ui.head.quickHack = function(quran) {
		...
		quran.bind('ayahTools:lastmark:created', self.update_lastmark);
		quran.bind('ayahTools:lastmark:updated', self.update_lastmark);
		quran.bind('ayahTools:lastmark:deleted', self.delete_lastmark);
	};
})( Quran, jQuery );
