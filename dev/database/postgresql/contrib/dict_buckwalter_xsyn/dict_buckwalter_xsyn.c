/*-------------------------------------------------------------------------
 *
 * dict_buckwalter_xsyn.c
 *	  Extended synonym dictionary
 *
 * Copyright (c) 2007-2010, PostgreSQL Global Development Group
 *
 * IDENTIFICATION
 *	  $PostgreSQL: pgsql/contrib/dict_buckwalter_xsyn/dict_buckwalter_xsyn.c,v 1.9 2010/02/26 02:00:32 momjian Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
PG_FUNCTION_INFO_V1(dbuckwalter_xsyn_init);
Datum		dbuckwalter_xsyn_init(PG_FUNCTION_ARGS);

PG_FUNCTION_INFO_V1(dbuckwalter_xsyn_lexize);
Datum		dbuckwalter_xsyn_lexize(PG_FUNCTION_ARGS);
...
Datum
dbuckwalter_xsyn_init(PG_FUNCTION_ARGS)
{
...
Datum
dbuckwalter_xsyn_lexize(PG_FUNCTION_ARGS)
{
